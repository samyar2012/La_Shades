  ...
  return (
    ...
    >
      <Header variants={headerVariants}>
        <Container>
          ...
          <Description variants={descriptionVariants}>
            Experience the perfect blend of luxury and convenience with our premium motorized shades. Combining sophisticated design with cutting-edge technology, these automated window treatments offer effortless control and enhanced functionality for your home.
          </Description>
        </Container>
      </Header>
      ...
      <Container>
        ...
        <StylesSection>
          <StylesTitle>Smart Collection</StylesTitle>
