...
import wovenWood1 from '../../../assets/photo_2025-06-01_20-53-12.jpg';
import wovenWood2 from '../../../assets/kimberley-alpuerto-gYCj5LrI9wI-unsplash.jpg';
import wovenWood3 from '../../../assets/moon-i87dB4Kd7nw-unsplash.jpg';
...
const Header = styled(motion.div)`
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),
              url(${wovenWood1}) center/cover no-repeat;
  padding: 2rem;
  text-align: center;
  color: white;
  margin: 0;
    ...
    >
      ...
      <Container>
        ...
        <CTASection variants={ctaVariants}>
          <CTATitle>Bring Nature's Beauty Indoors</CTATitle>
          <CTADescription>
            Discover how our woven wood shades can transform your space with natural elegance. Our design experts are ready to help you select the perfect woven wood shade that combines organic beauty with sophisticated style.
          </CTADescription>
          <CTALink 
            to="/contact"
            whileHover={{ scale: 1.05 }}
...
export default WovenWoodShades; 