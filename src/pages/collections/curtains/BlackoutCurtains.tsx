...
const BlackoutCurtains: React.FC = () => {
  const features = [
    {
      title: 'Complete Light Blocking',
      description: 'Our blackout curtains block up to 99% of light, creating the perfect dark environment for sleep.'
    },
    {
      title: 'Energy Efficiency',
      description: 'Helps regulate room temperature, reducing energy costs while maintaining comfort.'
    },
    {
      title: 'Noise Reduction',
      description: 'The thick fabric helps absorb sound, creating a quieter, more peaceful environment.'
    },
    {
      title: 'Premium Materials',
      description: 'Crafted from high-quality, durable fabrics that maintain their shape and color over time.'
    },
    {
      title: 'Custom Sizing',
      description: 'Every blackout curtain is custom-made to fit your windows perfectly.'
    },
    {
      title: 'Easy Maintenance',
      description: 'Designed for easy cleaning and maintenance, keeping your space looking fresh.'
    }
  ];
    ...
    >
      <Header variants={headerVariants}>
        <Container>
          ...
          <Title variants={titleVariants}>Blackout Curtains</Title>
          <Description variants={descriptionVariants}>
            Experience the perfect sleep environment with our premium blackout curtains, designed to block light and create a peaceful atmosphere.
          </Description>
        </Container>
      </Header>
      ...
      <Container>
        ...
        <CTASection>
          <Container>
            ...
            <CTADescription>
              Schedule a consultation with our design experts to find the perfect blackout curtains for your home.
            </CTADescription>
