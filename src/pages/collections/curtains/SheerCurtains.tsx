...
const SheerCurtains: React.FC = () => {
  const features = [
    {
      title: 'Light Filtering',
      description: 'Our sheer curtains gently filter natural light, creating a soft, diffused glow in your space.'
    },
    {
      title: 'Privacy with Style',
      description: 'Maintain privacy while still allowing natural light to flow through your windows.'
    },
    {
      title: 'Versatile Design',
      description: 'Perfect for layering with other window treatments or using alone for a light, airy look.'
    },
    {
      title: 'Premium Fabrics',
      description: 'Crafted from high-quality materials that are both durable and beautiful.'
    },
    {
    ...
    {
      title: 'Custom Sizing',
      description: 'Every sheer curtain is custom-made to fit your windows perfectly.'
    }
  ];
    ...
    >
      <Header variants={headerVariants}>
        <Container>
          ...
          <Title variants={titleVariants}>Sheer Curtains</Title>
          <Description variants={descriptionVariants}>
            Discover our collection of elegant sheer curtains, perfect for creating a light and airy atmosphere in any room.
          </Description>
        </Container>
      </Header>
      ...
      <Container>
        ...
        <CTASection>
          <Container>
            ...
            <CTADescription>
              Schedule a consultation with our design experts to find the perfect sheer curtains for your home.
            </CTADescription>
